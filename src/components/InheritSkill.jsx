...
import { rolClasses, rolRaces } from '../data/Data.js';
import { 
  Box, 
  Paper, 
  Typography, 
...
function InheritSkill({skill, reducePod }) {
  ...
  const handleClickUseSkill = () => {
    reducePod(skill.advance[0].cost);
  };
      ...
      <Paper
        ...
        >
          ...
          >
            ...
            <Tooltip title={skill.type === 'Pasiva' ? 'pasiva' : 'Usar habilidad: -' + skill.advance[0].cost + ' POD'} arrow>
              <div>
